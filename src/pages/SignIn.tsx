...
export function SignIn() {
    ...
    return (
        <div
            className="w-screen min-h-screen py-12 bg-gray-900 flex flex-col items-center justify-center text-gray-100 gap-8">
            ...
            <form onSubmit={handleSignIn} className="flex flex-col items-stretch gap-5">
